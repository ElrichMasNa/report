...
|:-------:|:----------:|:-------------------------------------:|:-----------------------------------------------------------:|
|   1.0   | 01/09/2025 | Jose Jhonatan Saavedra Angulo (Líder) | Avance de Lean UX procces                                   |
...
La solucion de **Smart Stay** esta dirigida a distintos actores del sector hotelero, cada uno con sus necesidades específicas:

- **Hoteles de mediana y gran escala**
  - Optimización de procesos, control de ocupación y reducción de costos operativos.
  - Beneficio: eficiencia administ y experiencias personalizadas para los huéspedes.
...
- **Empresas de gestón hotelera**
  - Administración de multiples propiedades con estándares unificados.
  - Beneficio: visión integral de la operación y mejora en la rentabilidad.
En resumen Smart Stay se orienta principalmente a los hoteles que buscán optimizar su gestión. 
